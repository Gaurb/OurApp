...
public interface MessageRepository extends MongoRepository<Message, ObjectId> {
    ...
    List<Message> findByRoomNameAndMessageTypeOrderByTimestampAsc(String roomName, MessageType messageType);
    List<Message> findByRoomNameAndMessageTypeOrderByTimestampDesc(String roomName, MessageType messageType, Pageable pageable);
